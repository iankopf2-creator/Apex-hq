...
- [x] Theme niche water_filtration (quote_first) — crisp filter slate-cyan (#0c4a6e / #67e8f9); whole-home vs under-sink vs RO / sediment-carbon-UV stages / water test hardness-iron-chlorine-TDS-bacteria / existing softener-well plumbing / filter change cadence / permit honesty when true; assess before firm price; no bait flat $/system or $/filter; no fake same-day whole-home pure-water guarantees; distinct from plumber, water_heater, water_softener, well_pump, sump_pump, water_damage, slab_leak
