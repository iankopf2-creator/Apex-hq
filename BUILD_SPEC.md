--- EVE HANDOFF ---
DONE: Owner mobile Expo Phase 0 stub (PR #20 `apps/owner-mobile`; no store submit); nosite HVAC #19 + Vitest #18 + Call AI dry-run #17 live; Stripe still dark
...
- [x] Owner mobile Expo Phase 0 stub (PR #20: `apps/owner-mobile`; Expo stub only — no App Store/Play submit)
