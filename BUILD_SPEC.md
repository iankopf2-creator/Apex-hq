--- EVE HANDOFF ---
DONE: theme niche mold_remediation (call_first) shipped; prior fire_smoke; towing+water PR #23; garage+locksmith+janitorial PR #22; free audit estimates + CRM status API (ESTIMATES ONLY)
