...
- [x] Theme niche french_drain (quote_first) — zinc trench-slate + wet-clay ochre (#3f3f46 / #a16207); soil type/water table/grade & slope/daylight vs sump discharge/trench length-depth-access/pipe-gravel-fabric/downspout/permit-HOA assess before firm price; no bait flat $/lf; no fake same-day dry basement guarantee; licensed contractor honesty only when true; distinct from basement_waterproofing, foundation_repair, water_damage, concrete flatwork, landscaping, plumber, slab_leak
