...
- [x] Theme niche sealcoating (quote_first) — warm asphalt charcoal + amber/orange road-crew; sqft/access/cracks/oil stains/weather/cure assess before firm price; no bait flat $/sqft; no fake same-day drive-on; sealcoat only (not full paving/concrete resurfacing)
