...
- [x] Theme niche septic_pumping (quote_first) — earthy tank-slate + soft algae/moss; tank size/access/last pump date/system type tank-vs-aerobic/distance/after-hours assess before firm price; no bait flat $/tank; local septic rules educational only (not legal advice); licensed/permitted when true; distinct from plumber, slab leak, water damage, junk removal, grease trap
