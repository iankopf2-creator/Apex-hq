...
- [x] Theme niche crack_sealing (quote_first) — deep crack-asphalt charcoal `#18181b` + hot-pour amber/copper `#d97706`; linear-ft/width-depth/surface/hot-pour-vs-cold-fill/weather/access/whether sealcoat-or-pave-needed assess before firm price; no bait flat $/lf; no fake same-day fill; distinct from asphalt paving, sealcoating-only, line striping, and concrete flatwork
