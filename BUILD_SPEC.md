...
- [x] Theme niche sump_pump (quote_first) — deep water-slate + bright pump cyan (#164e63 / #22d3ee); pit size / existing pump age-HP / check valve / discharge line freeze risk / battery backup vs water-powered backup / alarm / float switch / crock condition / effluent route / permit-electrical honesty when true; assess before firm price; no bait flat $/pump; no fake never-flood or same-day dry basement guarantees; distinct from basement_waterproofing, french_drain, crawl_space_encapsulation, plumber, water_damage, foundation_repair, radon_mitigation
