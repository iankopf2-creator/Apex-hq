...
- [x] Theme niche transfer_switch (quote_first) — deep utility/electrical charcoal `#0f172a` + safety copper/bronze accent `#d97706`; main panel amperage + main breaker size / generator type (portable vs standby) when true / ATS vs MTS when true / critical-loads panel vs whole-home transfer / utility interlocking / breakers when true / existing generator / ATS / interlock already installed honesty when true / outdoor pad / clearance / fuel type (natural gas / propane / diesel) when true / EV / solar / battery / surge SPD coexistence when true / permit + licensed electrician honesty when true; assess before firm price; no bait flat $/amp or $/switch; no fake same-day install; no scare outage copy; no inventing NEC/UL as Apex legal advice; no competitor brand cloning (Generac / Kohler / Briggs / Reliance / Siemens / Eaton as Apex product); distinct from generator, whole_home_surge, panel_upgrade, battery_storage, ev_charger, solar, electrician, hvac
