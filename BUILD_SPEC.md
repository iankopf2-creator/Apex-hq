...
- [x] Theme niche lawn_care (quote_first) — fresh lawn green `#14532d` + soft lime/sun `#a3e635`; lot size/turf condition/access/obstacles/frequency assess before firm price; no bait flat $/visit; no fake same-day; no overnight lawn makeovers; residential & commercial mow; quote before schedule
