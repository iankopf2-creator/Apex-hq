...
- [x] Theme niche boiler (quote_first) — cast-iron boiler brown-charcoal + hydronic copper-orange (#1c1410 / #ea580c); home size/heated sqft + climate zone / existing boiler age+fuel (gas/oil/propane/electric) + type (hot-water hydronic vs steam) / AFUE when true / radiators vs baseboard vs radiant loops / zone valves / circulator pumps / expansion tank + air elimination / venting+combustion air / chimney liner when true / electrical or gas/oil line / thermostat + outdoor reset when true / permit + licensed HVAC/plumbing-boiler contractor honesty when true; assess before firm price; no bait flat $/BTU or $/sqft or $/boiler; no fake same-day whole-home heat; no scare emergency copy (hvac owns call-first); distinct from furnace, heat_pump, mini_split, hvac, water_heater, tankless_water_heater, generator, insulation, electrician, plumber, solar, duct_cleaning
