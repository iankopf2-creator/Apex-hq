...
- [x] Theme niche mini_split (quote_first) — deep slate-teal outdoor-unit + cool mint/ice (#0f3d3e / #5eead4); zones/rooms / BTU load / single vs multi-head / existing ducted HVAC vs window units / electrical panel / outdoor pad/clearance / line-set length / wall material / stories/access / permit + licensed HVAC contractor honesty when true; assess before firm price; no bait flat $/head or $/ton; no fake same-day whole-home comfort guarantees; distinct from hvac, duct_cleaning, insulation, electrician, plumber, water_heater, generator, solar
