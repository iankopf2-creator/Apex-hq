...
- [x] Theme niche smart_panel (quote_first) — deep smart-grid charcoal/navy `#0c1222` + cool circuit sky/cyan accent `#38bdf8`; main panel amperage + main breaker size / full panel replacement vs smart overlay / retrofit when true / circuit count / breaker map / load inventory when true / EV / solar / battery / generator / transfer switch / surge SPD coexistence when true / utility interconnection / demand response / TOU when true / Wi-Fi / app / monitoring honesty when true (no fake always-online) / permit + licensed electrician honesty when true; assess before firm price; no bait flat $/circuit or $/panel; no fake same-day install; no scare blackout copy; no inventing NEC/UL as Apex legal advice; no competitor brand cloning (Span / Schneider / Leviton / Eaton / Square D / Siemens as Apex product); distinct from panel_upgrade, transfer_switch, battery_storage, generator, whole_home_surge, ev_charger, solar, electrician, hvac
