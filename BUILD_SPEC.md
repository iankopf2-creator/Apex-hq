...
- [x] Theme niche wildlife_removal (quote_first) — night-attic slate + lantern/caution amber (#0f172a / #f59e0b); species ID/entry points/attic-crawl access/exclusion vs live-trap vs one-way door/cleanup-sanitation/seasonal nesting/local permit-wildlife rehab assess before firm price; no bait flat $/animal or $/attic; no fake same-day guaranteed catch; licensed/insured / state wildlife permit honesty only when true; educational only on local laws (not legal advice); distinct from pest_control (insects call_first), tree_service, junk_removal, mold_remediation, handyman
