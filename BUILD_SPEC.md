--- EVE HANDOFF ---
DONE: theme niche fire_smoke (call_first) shipped; prior towing+water PR #23; garage+locksmith+janitorial PR #22; free audit estimates + CRM status API (ESTIMATES ONLY)
