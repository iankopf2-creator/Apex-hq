...
- [x] Theme niche irrigation (quote_first) — deep irrigation green `#14532d` + sky-spray blue `#0284c7`; zones/lawn size/existing vs new/controller/drip vs spray/winterization/access assess before firm price; no bait $/zone or $/head; no fake same-day install; HOA/permit & licensed plumber/irrigation honesty when required
