...
- [x] Theme niche crawl_space_encapsulation (quote_first) — damp-crawl charcoal + vapor-barrier lime (#292524 / #65a30d); crawl height/access/soil-vs-vapor-barrier/moisture-humidity/insulation type/rim-joist-sill/sump-dehumidifier/radon educational-only/pest-HVAC/permit-HOA assess before firm price; no bait flat $/sqft; no fake same-day dry crawl guarantee; licensed contractor honesty only when true; distinct from basement_waterproofing, french_drain, foundation_repair, water_damage, mold_remediation, attic insulation
