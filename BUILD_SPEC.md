...
- [x] Theme niche stump_grinding (quote_first) — deep bark charcoal + warm stump/mulch amber; stump count/diameter/root flare/access (gate/slope/overhead lines)/buried utilities/grind depth (below grade / flush)/haul-away chips vs leave mulch/species-hardness when true assess before firm price; no bait flat $/stump; no fake same-day; local permit/HOA educational only (not legal advice); distinct from tree_service (call_first storm), landscaping, lawn care, junk removal, concrete, excavation
