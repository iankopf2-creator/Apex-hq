...
- [x] Theme niche furnace (quote_first) — warm furnace charcoal + ember orange (#1a1210 / #fb923c); home size/sqft + climate zone / existing furnace age+fuel (gas/electric/oil/propane) / AFUE when true / ductwork / venting+combustion air / electrical or gas line / thermostat / permit + licensed HVAC contractor honesty when true; assess before firm price; no bait flat $/BTU or $/sqft; no fake same-day whole-home heat; no scare emergency copy (hvac owns call-first); distinct from hvac, heat_pump, mini_split, boiler, generator, insulation, electrician, plumber, water_heater, duct_cleaning, solar
