...
- [x] Theme niche water_softener (quote_first) — deep mineral teal + soft salt-crystal (#115e59 / #fcd34d); hardness grains / existing softener age-capacity / resin condition / brine tank / salt type / iron-manganese / well vs municipal / drain for backwash / space / electrical / bypass valve / permit honesty when true; assess before firm price; no bait flat $/softener or $/grain; no fake forever-soft or same-day whole-home guarantees; distinct from plumber, sump_pump, water_damage, slab_leak, appliance_repair
