...
const NICHE_FIX: Record<string, string> = {
  ...
  dumpster_rental:
    "Add a quote-first dumpster rental page (size/duration/debris/access/driveway-protection assess before firm price; permit/HOA honesty when true) so callers get a real roll-off quote — not bait flat $/day or fake same-day drop; distinct from junk removal haul-away.",
  countertops:
