...
const NICHE_FIX: Record<string, string> = {
  ...
  duct_cleaning:
    "Add a quote-first air duct cleaning page (whole-home / light-commercial + home size/system age/access/contamination assess before firm price; no bait flat per-vent; no fake same-day sanitize; not medical/mold claims) so callers get a real quote — not bait fees.",
  countertops:
