...
const NICHE_FIX: Record<string, string> = {
  ...
  irrigation:
    "Add a quote-first irrigation page (sprinkler repair/install + zone count/lawn size/existing vs new/controller/drip vs spray/winterization/access assess before firm price) so callers get a real quote — not bait flat $/zone or $/head or fake same-day install.",
  countertops:
