...
const NICHE_FIX: Record<string, string> = {
  ...
  lawn_care:
    "Add a quote-first lawn care page (residential/commercial mow + lot size/turf condition/access/obstacles/frequency assess before firm price) so callers get a real quote — not bait flat $/visit or fake same-day.",
  countertops:
