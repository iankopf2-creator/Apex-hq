...
const NICHE_FIX: Record<string, string> = {
  ...
  basement_waterproofing:
    "Add a quote-first basement waterproofing page (interior/exterior + french drain/sump when relevant + sqft/wall-height/existing drainage/vapor barrier/crawl-vs-poured-vs-block/access/weather assess before firm price; mold-adjacent referral only — not remediation; licensed contractor honesty when true) so callers get a real quote — not bait flat $/lf or $/sqft or fake same-day dry-out; distinct from water_damage emergency restoration and foundation_repair piers/slabs.",
  countertops:
