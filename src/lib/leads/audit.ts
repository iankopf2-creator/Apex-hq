...
const NICHE_FIX: Record<string, string> = {
  ...
  crack_sealing:
    "Add a quote-first crack sealing page (asphalt lot/driveway/road crack fill & seal + linear-ft/width-depth hairline-vs-alligator/surface hot-pour-vs-cold-fill/weather/access assess before firm price) so callers get a real quote — not bait flat $/lf or fake same-day fill; distinct from asphalt paving, sealcoating-only, line striping, and concrete flatwork.",
  countertops:
