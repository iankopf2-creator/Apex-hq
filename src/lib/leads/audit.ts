...
const NICHE_FIX: Record<string, string> = {
  ...
  sealcoating:
    "Add a quote-first sealcoating page (asphalt driveway/parking-lot + sqft/access/cracks/oil stains/weather/cure assess before firm price; sealcoat only — not full paving or concrete resurfacing) so callers get a real quote — not bait flat $/sqft or fake same-day drive-on.",
  countertops:
