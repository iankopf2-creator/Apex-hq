...
- Whole-home surge protection — quote_first (deep electrical-protection charcoal `#111827` + protective amber/gold `#eab308`; service entrance amperage + panel main breaker / existing SPD type (Type 1 vs Type 2 vs point-of-use) / grounding bonding / critical loads / install location / generator-EV-solar-battery coexistence / permit + licensed electrician assess before firm price; no bait flat $/panel or $/device; no fake same-day install; no scare lightning-fire copy; no inventing UL/NEC as Apex legal advice; distinct from electrician, panel_upgrade, generator, battery_storage, ev_charger, solar, hvac)
...
- quote_first for commercial janitorial + junk_removal + pressure_washing + gutter_cleaning + window_cleaning + carpet_cleaning + flooring + fencing + concrete + siding + decking + masonry + drywall + insulation + tile + cabinets + countertops + landscaping + auto_detail + foundation_repair + solar + epoxy_flooring + whole_home_surge
