# Theme AI — niche roadmap (profit coverage)
...
- Fencing — quote_first (cedar/fence-stain warm brown + charcoal slate + forest sage CTA; length/height/terrain/posts/HOA assess before firm price; no bait flat $/ft; wood/vinyl/chain-link/ornamental when true)
- Concrete — quote_first (wet-concrete cool gray/slate + warm amber CTA; sqft/access/thickness/prep/drainage assess before firm price; no bait flat $/sqft; no fake same-day pour; driveway/patio/flatwork)
...
- Insulation — quote_first (warm cellulose/attic taupe-slate + soft insulation-pink; sqft/access/attic-vs-wall-vs-crawl/existing R-value/moisture-ventilation/height assess before firm price; no bait flat $/sqft; no fake same-day; HOA/permit honesty when true; quote before blow-in/batts/spray-foam)
...
- LED Lighting — quote_first (deep workshop charcoal/navy `#10141c` + bright LED amber `#facc15`; fixture count / type recessed-troffer-high-bay-exterior-landscape / lamp-ballast vs full fixture swap / voltage-circuit capacity / height-lift-access / indoor-outdoor wet-location / CCT-CRI-controls 0-10V occupancy daylight / rebate-utility educational only (no inventing rebate amounts as Apex guarantee) / permit + licensed electrician assess before firm price; no bait flat $/fixture or $/lamp; no fake same-day whole-building retrofit; no scare energy-bill copy; no inventing ENERGY STAR/DLC/NEC as Apex legal advice; no competitor brand cloning (Philips / Cree / Lithonia / Hubbell as Apex product); distinct from electrician, smart_panel, panel_upgrade, solar, ev_charger, handyman) — live-on-branch `builder/led-lighting-niche` (shipped note; leave merge to Ian)
...
- quote_first for commercial janitorial + junk_removal + pressure_washing + gutter_cleaning + window_cleaning + carpet_cleaning + flooring + fencing + concrete + siding + decking + masonry + drywall + insulation + tile + cabinets + countertops + landscaping + auto_detail + foundation_repair + solar + epoxy_flooring + led_lighting
