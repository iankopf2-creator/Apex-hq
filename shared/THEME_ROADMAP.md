...
- Smart panel — quote_first (deep smart-grid charcoal/navy `#0c1222` + cool circuit sky/cyan `#38bdf8`; main panel amperage + main breaker / full replacement vs smart overlay retrofit / circuit count breaker map load inventory / EV-solar-battery-generator-transfer-surge coexistence / utility interconnect demand response TOU / Wi-Fi app monitoring honesty (no fake always-online) / permit + licensed electrician assess before firm price; no bait flat $/circuit or $/panel; no fake same-day install; no scare blackout copy; no inventing NEC/UL as Apex legal advice; distinct from panel_upgrade, transfer_switch, battery_storage, generator, whole_home_surge, ev_charger, solar, electrician, hvac) — live-on-branch `builder/smart-panel-niche` (shipped note; leave merge to Ian)
...
- quote_first for commercial janitorial + junk_removal + pressure_washing + gutter_cleaning + window_cleaning + carpet_cleaning + flooring + fencing + concrete + siding + decking + masonry + drywall + insulation + tile + cabinets + countertops + landscaping + auto_detail + foundation_repair + solar + epoxy_flooring + smart_panel
