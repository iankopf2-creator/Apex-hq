...
- Transfer switch — quote_first (deep utility/electrical charcoal `#0f172a` + safety copper/bronze `#d97706`; main panel amperage + main breaker / generator type portable vs standby / ATS vs MTS / critical-loads vs whole-home / utility interlocking / existing generator ATS interlock / outdoor pad clearance fuel / EV-solar-battery-surge coexistence / permit + licensed electrician assess before firm price; no bait flat $/amp or $/switch; no fake same-day install; no scare outage copy; no inventing NEC/UL as Apex legal advice; distinct from generator, whole_home_surge, panel_upgrade, battery_storage, ev_charger, solar, electrician, hvac) — live-on-branch `builder/transfer-switch-niche` (shipped note; leave merge to Ian)
...
- quote_first for commercial janitorial + junk_removal + pressure_washing + gutter_cleaning + window_cleaning + carpet_cleaning + flooring + fencing + concrete + siding + decking + masonry + drywall + insulation + tile + cabinets + countertops + landscaping + auto_detail + foundation_repair + solar + epoxy_flooring + transfer_switch
